...
twoway (scatter mmyoutcomenext difshare) (line allfitqiN allfitlinN difshare if dummyd==0,  lcolor(red black) lpattern(dash)) ///
...
predict LinFit2
twoway (scatter mrunagain difshare if difshare >=-.25 & difshare <=.25) (line LinFit2 difshare if difshare <= 0 & difshare >=-.25 & difshare <=.25,  lcolor(red black) lpattern(dash)) ///
...
predict LinFit3
twoway (scatter mofficeexp difshare) (line LinFit3 difshare if difshare <= 0,  lcolor(red black) lpattern(dash)) ///
...
predict LinFit4
twoway (scatter melectexp difshare if difshare >=-.25 & difshare <=.25) (line LinFit4 difshare if difshare <=0 & difshare >=-.25 & difshare <=.25,  lcolor(red black) lpattern(dash)) ///
...
predict LinFit5
twoway (scatter mmyoutcomenext difshare if difshare >=-.25 & difshare <=.25) (line LinFit5 difshare if difshare <= 0 & difshare >=-.25 & difshare <=.25,  lcolor(red black) lpattern(dash)) ///
...
predict LinFit6
twoway (scatter mrunagain difshare if difshare >=-.25 & difshare <=.25) (line LinFit6 difshare if difshare <= 0 & difshare >=-.25 & difshare <=.25,  lcolor(red black) lpattern(dash)) ///
